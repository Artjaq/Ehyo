...
- ~~Minimap / boussole permanente.~~ **Fait** : minimap bakée coin haut-droit
  (`Level.getMinimap` + `drawMinimap` moteur — layout re-baké seulement à
  l'ouverture d'une porte ; joueur, rect caméra, caches, boss par-dessus).
